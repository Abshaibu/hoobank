...
const Hero = () => {
    return (
        <section>
            ...
            <div className="container mx-auto mt-20 mb-32 flex flex-wrap items-center gap-4 justify-between">
                <p className="lg:pl-7 pl-0 font-medium text-[40px] text-white flex items-center gap-4">
                    3800+
                    <span className="text-gradient uppercase text-xl">user active</span>
                </p>
                <span className="lg:block hidden w-[1.7px] bg-gray h-[12px]"></span>
                <p className="font-medium text-[40px] text-white flex items-center gap-4">
                    230+
                    <span className="text-gradient uppercase text-xl">trusted by company</span>
                </p>
                <span className="lg:block hidden w-[1.7px] bg-gray h-[12px]"></span>
                <p className="font-medium text-[40px] text-white flex items-center gap-4">
                    $230M+
                    <span className="text-gradient uppercase text-xl">transaction</span>
                </p>
            </div>
        </section>
    )
